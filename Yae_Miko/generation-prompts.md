...
Persona-specific action: Gently drooping fox ears and a little chagrin, no tears or effects.
...
Clean extraction: crisp opaque edges, safe padding, no scenery, text, guide marks, checkerboard, shadows, glows, motion blur, speed lines, dust, detached effects, stray pixels, or chroma-key colors inside the pet.
Persona-specific action: Tiny visible breathing, one blink, gentle hair and fox-ear follow-through.
...
Clean extraction: crisp opaque edges, safe padding, no scenery, text, guide marks, checkerboard, shadows, glows, motion blur, speed lines, dust, detached effects, stray pixels, or chroma-key colors inside the pet.
Persona-specific action: Lighthearted happy small jump, compact limbs.
...
Eight left-to-right slots:
1. DOWN: front torso, chin tucked, visible face, pupils directed below her. No rear view.
2. DOWN and a little SCREEN-LEFT: chin tucked, nose begins moving toward image left, eyes down-left.
3. DOWN-LEFT: head turned viewer-left, eyes lowered left.
4. LEFT and a little DOWN: clearly LEFT-facing head, nose toward left image edge, eyes just below horizontal.
5. LEFT: match the FOURTH pose of the approved cardinal strip. Nose tip and pupils on the LEFT side of the head center. Do not reverse this pose.
6. LEFT and a little UP: LEFT-facing head, chin begins raising, eyes up-left.
7. UP-LEFT: LEFT yaw with raised chin and high eyes.
8. UP and a little LEFT: nearly frontal raised chin, high pupils slightly image-left; smoothly precedes row9 first UP pose.
...
Clean extraction: crisp opaque edges, safe padding, no scenery, text, guide marks, checkerboard, shadows, glows, motion blur, speed lines, dust, detached effects, stray pixels, or chroma-key colors inside the pet.
Persona-specific action: Focused observation through slight forward lean and narrowing attentive eyes.
...
Clean extraction: crisp opaque edges, safe padding, no scenery, text, guide marks, checkerboard, shadows, glows, motion blur, speed lines, dust, detached effects, stray pixels, or chroma-key colors inside the pet.
Persona-specific action: Serious thoughtful expression, hand near chin, feet planted.
...
Clean extraction: crisp opaque edges, safe padding, no scenery, text, guide marks, checkerboard, shadows, glows, motion blur, speed lines, dust, detached effects, stray pixels, or chroma-key colors inside the pet.
Persona-specific action: Expectant head tilt, inquisitive open eyes, politely waiting for user.

REPAIR: Previous six poses overlapped through the long hair. Make each COMPLETE character INCLUDING HAIR occupy at most 70% of its equal slot width with at least 15% pure cyan side margins. Keep visible cyan gutters from canvas top to bottom between every pose. Six full-body figures, all separated, zero touching hair or ornaments. Use long hair tucked closer to body while preserving canonical design. No outer-canvas clipping.
...
Clean extraction: crisp opaque edges, safe padding, no scenery, text, guide marks, checkerboard, shadows, glows, motion blur, speed lines, dust, detached effects, stray pixels, or chroma-key colors inside the pet.
Persona-specific action: Playful friendly hand wave with a gentle sly smile.
