...
本仓库采用分离许可，不同类型的内容适用不同条款：

| 内容 | 适用条款 |
| --- | --- |
| 配置文件、脚本及原创文档 | [MIT License](LICENSE) |
| PNG、GIF、WebP、图集、头像及预览素材中由仓库作者拥有的原创部分 | [CC BY-NC 4.0 与素材附加说明](ASSET_LICENSE.md) |
| 第三方角色名称、形象、商标及其他知识产权 | 不属于本仓库授权范围，参见 [NOTICE.md](NOTICE.md) |

本仓库为非官方同人项目，与 HoYoverse、COGNOSPHERE、Crypton Future Media
及其他权利方不存在隶属、赞助、认可或合作关系。仓库公开可见不代表第三方
角色知识产权可以自由使用；使用者仍需遵守适用法律及相应权利方的政策。
